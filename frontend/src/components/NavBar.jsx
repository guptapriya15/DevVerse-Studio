...
const handleLogout=async ()=>{
  ...
  return (
    <div className="w-full h-16 bg-white/70 dark:bg-white/[0.03] backdrop-blur-xl border-b border-slate-200 dark:border-white/[0.07] flex items-center px-6 gap-6 font-sans transition-colors duration-300">
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          onClick={toggleTheme}
          className="flex w-9 h-9 items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/[0.06] transition-colors duration-150"
        >
        ...
        <div className="relative ml-1">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-slate-600 to-slate-700 dark:from-slate-200 dark:to-white flex items-center justify-center overflow-hidden ring-black/5 dark:ring-white/20">
          ...
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-52 bg-white/95 dark:bg-[#12121c]/95 backdrop-blur-xl border border-slate-200 dark:border-white/[0.08] rounded-xl shadow-xl py-1.5 z-50 animate-[fadeIn_0.15s_ease-out]">
              ...
              <div>
                <button onClick={handleLogout} className="w-full items-center gap-2.5 px-3.5 py-2 text-[13px] text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors duration-150">
                  <LogOut size={15} />
                  Logout
                </button>
              </div>
